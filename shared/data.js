// Business data + i18n strings for JV Patios & Stonework
window.JV = {
  business: {
  ...
  // Service area cities (Annapolis radius)
  cities: [
  ...
  // Real Unsplash imagery — patios, stonework, landscapes
  images: {
    ...
    // Before / after pairs (synthesized — uses two distinct views)
    beforeAfter: [
      {
