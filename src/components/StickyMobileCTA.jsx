...
export default function StickyMobileCTA({ lang, onQuote }) {
  const t = JV.t[lang]
  ...
  return (
    <div className="jv-sticky" data-show={show}>
      ...
      <a className="jv-sticky-btn jv-sticky-wa" href={`https://wa.me/${JV.business.whatsapp}`} target="_blank" rel="noopener noreferrer">
